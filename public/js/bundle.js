        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // programatically navigato to home screen after 1.5s
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Welcome to the Natours family!'); // programatically navigate to login screen after 1.5s
          ...
          case 7:
            ...
            msg = ''; // native message is janky, so specially define one if there is a user with the same email

            if (_context.t0.response.data.message.includes('key')) msg = 'A user with this email already exists!'; // if the error is not for duplicate users, set error to the native one

            !msg && (msg = _context.t0.response.data.message);
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"contact.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendContactsEmail = void 0;
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // forces a reload from the server cache
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Message sent successfully! We'll be in touch immediately"); // programatically navigate to login screen after 1.5s
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error sending email! Try again!');
  ...
  return function sendContactsEmail(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.sendContactsEmail = sendContactsEmail;
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"updateData.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createNewPass.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewPass = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(url, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Success! Your new password has been set!');
              setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Error occurred while saving new password! Please try again later!');
  ...
  return function createNewPass(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var _createNewPass = require("./createNewPass");
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(email, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", (0, _alerts.showAlert)('error', 'Passwords are not the same!'));
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _createNewPass.createNewPass)(res.data.data.resetURL, password, passwordConfirm);
            }
  ...
  return function forgotPassword(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.forgotPassword = forgotPassword;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./createNewPass":"createNewPass.js"}],"submitReview.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmVzZWwtb3V0IiwiYSI6ImNqaXZnaDExeTJrcTEzd3BhOXhjYmxwajkifQ.131KHjl660lf66ahdYc6tw';
  ...
  locations.forEach(function (location) {
    ...
    marker.setPopup(popup); // extend map's bounds to include current location
...
// public key
var stripe = Stripe('pk_test_0E7cOO7wDH9X5mAX4b9bQBdB00WxOdpQSF'); // tourId comes from the front-end button's data-tour-id attribute
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)( // `http://localhost:8000/api/v1/bookings/checkout-session/${tourId}` // for development
...
var form = document.querySelector('.form--login'); // billing

var formBilling = document.querySelector('.form--billing');
...
var contactsBtn = document.querySelector('.btn--contacts');
var accountSideNav = document.querySelector('.side-nav');
...
if (signupBtn) {
  signupBtn.addEventListener('click', function (e) {
    e.preventDefault(); // recreating multipart form data
    ...
    if (!name || !email || !password || !passwordConfirm) return (0, _alerts.showAlert)('error', 'Please fill out all the required information!');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateData.updateUserData)(form, 'data');
  });
}
...
if (userPasswordForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var passwordBtn, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              passwordBtn = document.querySelector('.btn--save-pasword');
...
if (alertMessage) (0, _alerts.showAlert)('success', alertMessage, 17); // toggle the active class on side menu list items

if (accountSideNav) {
  accountSideNav.addEventListener('click', function (e) {
    var sideEls = Array.from(accountSideNav.children);
    sideEls.forEach(function (child) {
...
if (cardExpiration) {
  cardExpiration.oninput = function (e) {
...
if (contactsBtn) {
  contactsBtn.onclick = function (e) {
    ...
    var subject = "Client message: ".concat(Array.from(radios).filter(function (radio) {
      return radio.checked;
    })[0].value);
    (0, _contact.sendContactsEmail)({
      email: email,
      subject: subject,
      name: name,
      message: message
...
if (forgotPasswordBtn) {
  forgotPasswordBtn.addEventListener('click', function (e) {
    ...
    var password = document.getElementById('password-forgot').value;
    var passwordConfirm = document.getElementById('password-confirm-forgot').value;
    (0, _forgotPassword.forgotPassword)(userEmail, password, passwordConfirm);
  });
}
