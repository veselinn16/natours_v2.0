      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            passwordCurrent = (_readOnlyError("passwordCurrent"), document.getElementById('password-current').value = '');
            password = (_readOnlyError("password"), document.getElementById('password').value = '');
